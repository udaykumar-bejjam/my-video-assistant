> **Status:** Design + implementation live on feature branches — see [IN_FLIGHT_BRANCHES.md](./IN_FLIGHT_BRANCHES.md). Not all referenced Swift files exist on `master` yet.
